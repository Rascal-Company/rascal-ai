...
import OnboardingSelectionPage from "./src/pages/OnboardingSelectionPage";
              ...
              <MonitoringProvider>
                <StrategyStatusProvider>
                  <Routes>
                    ...
                    <Route
                      path="/leadmagnet/:token"
                      element={<LeadMagnetPage />}
                    />

                    {/* Onboarding valintasivu (ilman layoutia) */}
                    <Route
                      path="/select"
                      element={
                        <ProtectedRoute>
                    ...
                    >
                      ...
                      <Route
                        path="/lead-scraping"
                        element={<LeadScrapingPage />}
                      />
                      <Route
                        path="/monitoring"
                        element={
                          <ProtectedRoute
                            requiredFeatures={["Media Monitoring"]}
                          >
                            <MediaMonitoringPage />
                          </ProtectedRoute>
                        }
