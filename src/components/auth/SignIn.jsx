...
export default function SignIn({ onClose, onForgotClick }) {
  ...
  useEffect(() => {
    if (pendingSuccess && user && !authLoading) {
      console.log("[SignIn] Navigating to selection page, user:", user.email);
      navigate("/select");
                ...
                {showPassword ? (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.956 9.956 0 012.223-3.592m3.34-2.591A9.956 9.956 0 0112 5c4.477 0 8.268 2.943 9.542 7a9.973 9.973 0 01-4.043 5.306M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                    />
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
