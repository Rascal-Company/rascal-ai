...
const TextEditModal = ({
    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-[0_32px_96px_-16px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col">
                ...
                <div className="p-8">
                    <textarea
                        ...
                        className="w-full h-[500px] p-6 border-2 border-gray-100 rounded-2xl text-base leading-relaxed bg-gray-50/50 focus:bg-white focus:border-purple-500 focus:ring-4 focus:ring-purple-500/10 outline-none transition-all resize-y"
